...
- Core course catalog (15 courses across levels 100, 200, 300)
...
def seed_initial_data():
	...
	with app.app_context():
		...
		print("\n[2/4] Creating Course Catalog (15 courses for IT Department)...")
		...
		print(f"  • Courses: 15 (all bound to IT Department, 3-credit hours each)")
